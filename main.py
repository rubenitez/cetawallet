...
class LoginScreen(QDialog):
    def __init__(self):
        ...
        self.passwordfield.setEchoMode(QtWidgets.QLineEdit.Password) # Put bullets to passwordfield
...
class CreateAccScreen(QDialog):
    def __init__(self):
        ...
        self.passwordfield.setEchoMode(QtWidgets.QLineEdit.Password)  # Put bullets to passwordfield
        self.confirmpasswordfield.setEchoMode(QtWidgets.QLineEdit.Password)  # Put bullets to passwordfield
